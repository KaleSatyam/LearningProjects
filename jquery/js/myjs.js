...
function my() {
    console.log("jquery in the desktop")

    //jquery effect
    // to hide j query effect
    $('#btn').click(function () {
        console.log("click to hide div")
        // $('#container').hide() 
...
$('#btn1').click(function () {
    console.log("on click to show div")
    // $('#container').show()
    $('#container').fadeIn()
})
...
//-----------------------------------------
//animations  animate({params},speed,callback functions)

$('#anibt1').click(function () {
    // $("#container").animate({width:"300",height:"200"},100,function(){
    // $("#container").animate({width:"+=300",height:"+=200"},100,function(){
    $("#container").animate({ width: "300", height: "200", opacity: 0.5, left: "250px" }, 500, function () {
        $("#container").animate(
            {
                left: "0",
                height: "100px",
...
$('#submit').click(function(){
    ...
    // getting value from input type
    // let val=$("#input").val()
    //     console.log(val)
    $("#input").val("satyam kale")
})

//using text fun getting text
$('#submit').click(function(){
